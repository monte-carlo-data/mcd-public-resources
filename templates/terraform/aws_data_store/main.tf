...
variable "external_id" {
  description = "External ID generated by Monte Carlo when registering this deployment. Required for new deployments. Copy it from the External ID field on the agent registration page in Monte Carlo. Leave blank only for existing deployments that already use the random ID generated by this module."
  type        = string
  default     = ""
}
...
locals {
  ...
  external_id                      = var.external_id != "" ? var.external_id : random_id.this.hex
}
